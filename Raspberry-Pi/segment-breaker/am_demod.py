...
class am_demod(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Am Demod")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '../data/5mb/no-output/file3_0_2.71432687.dat', False, 2000000, 20000)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_complex_to_mag_1 = blocks.complex_to_mag(1)
        self.blocks_add_const_vxx_1 = blocks.add_const_ff(-1.1)
